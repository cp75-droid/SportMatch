...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 36, fontWeight: 'bold', color: 'white', marginBottom: 12 },
  tagline: { fontSize: 18, color: 'white', opacity: 0.9, textAlign: 'center', marginBottom: 48 },
  buttonPrimary: { backgroundColor: 'white', paddingVertical: 16, paddingHorizontal: 48, borderRadius: 30, marginBottom: 16, width: '100%', alignItems: 'center' },
  buttonPrimaryText: { color: '#FF6B6B', fontSize: 16, fontWeight: 'bold' },
  buttonSecondary: { borderWidth: 2, borderColor: 'white', paddingVertical: 16, paddingHorizontal: 48, borderRadius: 30, width: '100%', alignItems: 'center' },
