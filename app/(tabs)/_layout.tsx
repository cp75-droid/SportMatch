...
export default function TabLayout() {
  return (
    <SafeAreaProvider>
      ...
      >
        <Tabs.Screen name="match" options={{ title: 'Explorer', tabBarIcon: ({ color }) => <Text style={{ fontSize: 20, color }}>⚡</Text> }} />
        <Tabs.Screen name="likes" options={{ title: 'Likes', tabBarIcon: ({ color }) => <Text style={{ fontSize: 20, color }}>❤️</Text> }} />
